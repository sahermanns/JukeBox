...
// This is my version of jQuery conversion//
function ShowSongs () {
  $("#songs").show();
  $("#songs option").hide();
...
var selectArtist = $("#artists");
selectArtist.on("change", ShowSongs);
var selectVid = $("#songs");
selectVid.on("change", PlaySong);

// // this is Brooks version but I cant quite get it right so I'm going to comment it out//

// function ShowSongs() {
// $('select#songs').show().children('option').hide()
// $('.'+ this.value).show();
// }
...
// $('#songs').on("change", PlaySong);
// $("#artists").on("change",ShowSongs);
